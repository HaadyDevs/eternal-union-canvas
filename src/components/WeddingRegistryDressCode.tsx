        ...
        <div className="flex-1 max-w-xs text-center mx-auto">
          <div className="relative mb-8">
            <img 
              ...
              alt="Registry" 
              className="w-full h-auto object-cover grayscale rounded"
            />
            {/* Overlapping Title */}
            <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-white px-4 py-2">
              <h3 className="text-xl md:text-2xl font-cinzel font-bold text-black uppercase">
                REGISTRY
              </h3>
            </div>
          </div>
